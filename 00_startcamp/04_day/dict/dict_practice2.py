...
pro-gj
"""
lecturers = ssafy.get('classes').get('gj')
for i in lecturers.values():
    print(i)
"""
...
"""
# key, value값 모두에 접근하기 위해서는 items() 필요!
frameworks=ssafy['language']['python']['frameworks'].items()

for name, attr in frameworks:
...
print(f'오늘의 당번은 {random.choice(group_e)}')