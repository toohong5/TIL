...
const images = [
    { heights: '34px', width: '39px'},
    { heights: '12px', width: '11px'},
    { heights: '292px', width: '56px'},
]
...
const heights = images.map(image => image.heights)
console.log(heights)
...
const comics = brands.map(function(x, i) { // x: 요소, i: 인덱스
