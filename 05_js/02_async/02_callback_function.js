...
console.log(numbersEach(NUMBERS, addEach)) // 더하기
console.log(numbersEach(NUMBERS, subEach)) // 빼기
console.log(numbersEach(NUMBERS, mulEach)) // 곱하기

// 그런데 addEach, subEach, mulEach 다시 사용 안할 것 같은데?
